...
# From mary get attribute pet set it to satan // satan is pet cat of mary.
mary.pet = satan

frank = Employee("Frank", 120000)  # Frank is an instance of Employee.

# From frank(instance of employee) get attribute pet set it to rover.
frank.pet = rover

# flipper is an instance of fish / alternatively property of fish.
flipper = Fish()

crouse = Salmon()  # crouse is an instance of Salmon / alternatively property

# harry is an instance of Halibut/ harry is property (name) of the fish.
harry = Halibut()
